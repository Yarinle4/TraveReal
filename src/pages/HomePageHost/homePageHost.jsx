...
function HomePageHost() {
  ...
  const events = [
    {
      ...
      description: "A night out at a local bar",
    ...
    },
    {
      ...
      description: "Architecture tour of the city",
      clickEvent: sliderClick,
    },
    {
      image: food,
    ...
    },
    {
      image: hiking,
      title: "Hiking Circle",
      description: "Life is better in hiking boots",
      clickEvent: sliderClick,
    },
    {
      image: sharedWorkspace,
      title: "Digital Nomads",
      description: "Work is where the wifi is",
      clickEvent: sliderClick,
    },
  ];
  ...
  const tips = [
    ...
    {
      image: challah,
      title: "Saturday Attractions",
      description: "Attractions available",
      clickEvent: sliderClick,
    },
    {
      image: Workshop,
      ...
      >
        ...
        >
          ...
          <Divider
            ...
            flexItem
            sx={{ marginLeft: "-30px", width: "30px", borderColor: "#F3FBF4" }}
          />
          <Button

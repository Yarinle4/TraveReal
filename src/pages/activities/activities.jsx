  ...
  const People = () => {
    ...
    >
      <Box sx={{ display: 'flex', gap: '10px', ml:2, mr:2, mb:2 }}>
        <div>
        <Avatar sx={{ width: 80, height: 80, mb:1 }} alt="Person 1" src={avatarPic} onClick={() => navigate("/ProfilePage")} />
        <Typography sx={{fontSize:'100%'}} align="center">Yarin Levy</Typography>
        </div>
        <div>
        <Avatar sx={{ width: 80, height: 80, mb:1 }} alt="Person 2" src={avatarPic} onClick={() => navigate("/ProfilePage")} />
        <Typography sx={{fontSize:'100%'}} align="center">Yarin Levy</Typography>
        </div>
        <div>
        <Avatar sx={{ width: 80, height: 80, mb:1  }} alt="Person 3" src={avatarPic} onClick={() => navigate("/ProfilePage")} />
        <Typography sx={{fontSize:'100%'}} align="center">Yarin Levy</Typography>
        </div>
        <div>
        <Avatar sx={{ width: 80, height: 80, mb:1  }} alt="Person 4" src={avatarPic} onClick={() => navigate("/ProfilePage")} />
        <Typography sx={{fontSize:'100%'}} align="center">Yarin Levy</Typography>
        </div>
        <div>
        <Avatar sx={{ width: 80, height: 80, mb:1  }} alt="Person 5" src={avatarPic} onClick={() => navigate("/ProfilePage")} />
        <Typography sx={{fontSize:'100%'}} align="center">Yarin Levy</Typography>
        </div>
        </Box>
    </div>
